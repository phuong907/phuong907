...
import org.example.oop_game_project.Components.BombComponent;
...
public class GameFactory implements EntityFactory {
    ...
    public Entity newBrickBreak(SpawnData data) {
        return FXGL.entityBuilder(data)
                ...
                .with(new org.example.oop_game_project.Components.BrickBreakComponent())
    ...
    public Entity newEnemy1(SpawnData data) {
        return entityBuilder(data)
                ...
                .with(new org.example.oop_game_project.Components.Enemy.Enemy1())
                .with(new CollidableComponent(true))
                .build();
    }
    ...
    public Entity newEnemy2(SpawnData data) {
        return entityBuilder(data)
                ...
                .bbox(new HitBox(new Point2D(5, 5), BoundingShape.box(38, 38)))
                .with(new org.example.oop_game_project.Components.Enemy.Enemy2())
                .with(new CollidableComponent(true))
                .build();
    }
    ...
    public Entity newEnemy3(SpawnData data) {
        return entityBuilder(data)
                ...
                .bbox(new HitBox(new Point2D(5, 5), BoundingShape.box(38, 38)))
                .with(new org.example.oop_game_project.Components.Enemy.Enemy3())
                .with(new CollidableComponent(true))
                .build();
    }
    ...
    public Entity newEnemy4(SpawnData data) {
        return entityBuilder(data)
                ...
                .bbox(new HitBox(new Point2D(5, 5), BoundingShape.box(38, 38)))
                .with(new org.example.oop_game_project.Components.Enemy.Enemy4())
                .with(new CollidableComponent(true))
                .build();
    }
    ...
    public Entity newEnemy5(SpawnData data) {
        return entityBuilder(data)
                ...
                .bbox(new HitBox(new Point2D(5, 5), BoundingShape.box(38, 38)))
                .with(new org.example.oop_game_project.Components.Enemy.Enemy5())
                .with(new CollidableComponent(true))
                .zIndex(1)
                .build();
    }
